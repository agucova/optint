...
def metrics(m, Y, alpha, Z, D, I, B, G, Cama, Uni, Q, S, N, P, T, A, E_start, E_end, COV, V, Aux, validation=False) -> Tuple[Dict, pd.DataFrame]:
    not_ideal = 0
    beds_changed = 0
    total_distance = 0
    ...
    if validation and m.status == 2.0:
        print_validation(m, Y, alpha, Z, D, I, B, G, Cama, Uni, Q, S, N, P, T, A, E_start, E_end, COV, V, Aux)
...
def print_validation(m, Y, alpha, Z, D, I, B, G, Cama, Uni, Q, S, N, P, T, A, E_start, E_end, COV, V, Aux):
